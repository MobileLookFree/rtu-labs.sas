 ...
 *
 * Время генерации '09.04.20, 21:30'
 ...
 *
 */
/* Определить шаблон секторной диаграммы */
proc template;
	define statgraph SASStudio.Pie;
		begingraph;
		layout region;
		piechart category=Age / group=Sex groupgap=2% datalabellocation=inside;
		endlayout;
		endgraph;
	end;
run;
...
proc sgrender template=SASStudio.Pie data=SASHELP.CLASSFIT;
run;
